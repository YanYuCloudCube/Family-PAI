...
### 核心功能
- ⚡ **@family-pai/core v1.0.0** - 极致信任核心引擎
...
- 📦 **NPM 包**: https://www.npmjs.com/package/@family-pai/core
...
\`\`\`typescript
import { createFamilyPai } from '@family-pai/core';
...
- 📦 **NPM 包**: https://www.npmjs.com/org/family-pai
...
open https://www.npmjs.com/package/@family-pai/core
```
...
# 导入测试
node -e "const pkg = require('@family-pai/core'); console.log(pkg.PACKAGE_INFO);"
```
...
```bash
# 废弃版本（72小时内）
npm deprecate @family-pai/core@1.0.0 "Please use latest version"

# 或强制撤销（不推荐）
npm unpublish @family-pai/core@1.0.0 --force
```
...
- [ ] @family-pai/core 已成功发布到 NPM
- [ ] family-pai 组织已在 npmjs.com 创建
